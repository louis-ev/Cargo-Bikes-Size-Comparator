  ...
  messages: {
    en: {
      message: {
        ...
        clear_measures: 'Clear measures',
        swap: 'Swap',
        swap_bikes_order: 'Move first bike to the end',
...
`,
    ...
    fr: {
      message: {
        ...
        close: 'fermer',
        measure: 'Mesurer',
        stop_measuring: 'Arrêter la mesure',
        clear_measures: 'Effacer les mesures',
        swap: 'Tourner',
        swap_bikes_order: 'Déplacer le premier vélo à la fin',
